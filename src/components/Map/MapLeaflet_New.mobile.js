...
const MapLeafletMobile = React.memo((props) => {
  ...
  }, [point?.heatmapRainfall?.precipitation1?.length, precipitation, tmp]);
  ...
  return (
    <div className="margin-mobi">
      <div className={classes.root}>
        <div id="map" style={mapStyles} />
        <div className="rain-color-unit-mobile cl-main-title">mm</div>
        <div className="rain-color-mobile">
      ...
      <Row>
            ...
            <Row style={{ alignItems: "center", paddingTop: "8px" }}>
              ...
              <Col span={2}>
                <img
                  ...
                  className={"btn-reload-mobi ft-cl-icon-reload-big"}
                />
              </Col>
            </Row>
          )}
        ...
        <Col span={24} style={{ marginBottom: "25px", padding: 5 }}>
          <Row>
            ...
            {props.point?.heatmapRainfall !== null && (
              <Col lg={24} md={24} sm={24}>
                <span className={`weather-map-time cl-text-label-info`}>
                  cập nhật lúc
                  {" " +
...
export default MapLeafletMobile;
